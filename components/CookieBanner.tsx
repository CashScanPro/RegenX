    ...
    >
      <div className="max-w-4xl mx-auto bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl shadow-black/50 p-5 sm:p-6">
        ...
        <div className="mt-3 pt-3 border-t border-gray-800 flex flex-wrap gap-3 text-xs text-gray-500">
          <Link href="/privacy" className="hover:text-green-400 transition-colors">{t.cookies.privacy}</Link>
          <Link href="/mentions-legales" className="hover:text-green-400 transition-colors">{t.cookies.legal}</Link>
          <Link href="/gdpr" className="hover:text-green-400 transition-colors">{t.cookies.gdpr}</Link>
        </div>
      </div>
    </div>
  );
