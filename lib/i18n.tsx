...
const fr: Translation = {
  pricingPage: {
    ...
    titleLine1: 'Choisissez votre niveau',
    titleLine2: 'de performance',
    subtitle: 'Sans engagement — Résiliable à tout moment — Remboursé sous 14 jours',
    popular: 'Populaire',
    perMonth: '/mois',
    cta: 'Commencer',
    ...
    plans: [
      ...
      { tagline: 'Pour coachs & équipes sportives', features: ['Tout le forfait Pro', 'Tableau de bord coach', 'Suivi équipe temps réel', 'Rapports de performance', 'Support dédié 24h/24', 'Conforme RGPD'] },
    ],
    badges: [
      { label: 'Conforme RGPD', sub: 'Hébergé en Europe' },
      { label: 'Sans engagement', sub: 'Résiliable à tout moment' },
      { label: 'Remboursement', sub: 'Sous 14 jours' },
      { label: 'IA Exclusive', sub: 'Coach 100% personnalisé' },
    ],
  },
  nav: {
...
const pt: Translation = {
  pricingPage: {
    back: 'Voltar',
    eyebrow: 'Preços',
    titleLine1: 'Escolha o seu nível',
    titleLine2: 'de desempenho',
    subtitle: 'Sem compromisso — Cancelável a qualquer momento — Reembolso em 14 dias',
    popular: 'Popular',
    perMonth: '/mês',
    cta: 'Começar',
    ...
    plans: [
      ...
      { tagline: 'Para treinadores e equipas desportivas', features: ['Tudo do plano Pro', 'Painel de treinador', 'Acompanhamento de equipa em tempo real', 'Relatórios de desempenho', 'Suporte dedicado 24h/24', 'Conforme RGPD'] },
    ],
    badges: [
      { label: 'Conforme RGPD', sub: 'Alojado na Europa' },
      { label: 'Sem compromisso', sub: 'Cancelável a qualquer momento' },
      { label: 'Reembolso', sub: 'Em 14 dias' },
      { label: 'IA Exclusiva', sub: 'Coach 100% personalizado' },
    ],
  },
  nav: {
