        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 1.5rem', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', marginTop: '3rem', paddingTop: '2.5rem', borderTop: '1px solid rgba(200,146,42,0.1)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2.5rem', flexWrap: 'wrap' }}>
              ...
              <a href="/boutique.html" title="Découvrir la boutique Eric Favre" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '130px', height: '130px', padding: '0.9rem', borderRadius: '16px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(200,146,42,0.25)', boxShadow: '0 8px 30px rgba(0,0,0,0.35)', cursor: 'pointer', transition: 'all 0.3s ease', boxSizing: 'border-box' }}><Image src="/log%20eric%20favre%201.webp" alt="Eric Favre" width={110} height={110} style={{ objectFit: 'contain', width: '100%', height: '100%' }} /></a>
            </div>
          </div>
        </div>
      </section>
