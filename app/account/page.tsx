...
export default async function AccountPage() {
  ...
  return (
    ...
    <div className="rx-eyebrow" style={{ marginBottom: '1rem' }}>★ Espace Membre</div>div>
    <h1 style={{ fontFamily: SERIF, fontSize: 'clamp(2.5rem, 4vw, 3.25rem)', fontWeight: 500, letterSpacing: '0.005em', color: '#F7EFDD' }}>Mon compte</h1>h1>
    </div>div>
    ...
    <div className="rx-eyebrow" style={{ color: 'rgba(255,255,255,0.3)', marginBottom: '1.75rem' }}>Profil</div>div>
    ...
    <div>
    <div style={{ fontFamily: SERIF, fontSize: '1.35rem', fontWeight: 600, color: '#fff' }}>{displayName}</div>div>
    <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>{email}</div>div>
    </div>div>
    </div>div>
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <span style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>{l}</span>span>
      <span style={{ fontSize: '0.85rem', fontWeight: 500, color: l === 'Statut' ? '#4ade80' : '#fff' }}>{v}</span>span>
      </div>div>
      ))}
    </div>div>
    </div>div>
    ...
    <div className="rx-eyebrow">Abonnement</div>div>
    </div>div>
    <div style={{ marginBottom: '1.75rem' }}>
    <div style={{ fontFamily: SERIF, fontSize: '2rem', fontWeight: 600, color: GOLD, letterSpacing: '0.01em' }}>Premium</div>div>
    <div style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.45)', marginTop: '6px', fontWeight: 300 }}>Accès illimité — Coach IA 24h/24</div>div>
    </div>div>
    ...
    <div className="rx-eyebrow" style={{ color: 'rgba(255,255,255,0.3)' }}>Données & confidentialité</div>div>
    </div>div>
