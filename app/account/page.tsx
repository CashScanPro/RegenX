...
const rawLastName = user.user_metadata?.last_name || '';
const firstName = rawFirstName || email.split('@')[0] || 'Athlète';
...
<ProfileForm initialFirstName={rawFirstName} initialLastName={rawLastName} />
</div>
