  ...
  return (
    <div className="min-h-screen bg-gray-950 py-24 px-4">
      <div className="max-w-2xl mx-auto">
        <Link href="/dashboard" className="text-green-400 hover:text-green-300 mb-8 inline-block">&larr; Dashboard</Link>
        ...
        <div className="space-y-6">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm mb-4">Telechargez toutes vos donnees au format JSON (profil, entrainements, nutrition, progression).</p>
