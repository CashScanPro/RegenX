...
return (
<div className="min-h-screen flex" style={{ backgroundColor: '#0a0a0a', backgroundImage: "linear-gradient(rgba(10,9,7,0.74), rgba(8,7,6,0.90)), url('/Regenx-lieu.webp')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat' }}>
...
<header className="sticky top-0 z-10 px-6 py-4 flex items-center gap-4" style={{ background: 'rgba(10,9,7,0.72)', backdropFilter: 'blur(18px) saturate(130%)', WebkitBackdropFilter: 'blur(18px) saturate(130%)', borderBottom: '1px solid rgba(200,146,42,0.18)' }}>
<div style={{ width: '44px', height: '44px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(232,184,75,0.22), rgba(200,146,42,0.12))', border: '1px solid rgba(200,146,42,0.4)' }}>
<Brain style={{ width: '20px', height: '20px', color: GOLD_LIGHT }} strokeWidth={1.5} />
</div>
<div>
...
{m.role === 'assistant' && (
<div style={{ width: '34px', height: '34px', borderRadius: '8px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '4px', background: 'linear-gradient(135deg, rgba(232,184,75,0.20), rgba(200,146,42,0.10))', border: '1px solid rgba(200,146,42,0.4)' }}>
<Brain style={{ width: '17px', height: '17px', color: GOLD_LIGHT }} strokeWidth={1.5} />
</div>
)}
<div className="whitespace-pre-wrap" style={Object.assign({ maxWidth: '80%', padding: '0.95rem 1.2rem', borderRadius: '10px', fontSize: '0.88rem', lineHeight: 1.7, fontWeight: 300 }, m.role === 'user' ? { background: 'linear-gradient(135deg, ' + GOLD_LIGHT + ', ' + GOLD + ')', color: '#0a0a0a', fontWeight: 500, boxShadow: '0 8px 24px -10px rgba(200,146,42,0.5)' } : { background: 'linear-gradient(160deg, rgba(28,24,18,0.55), rgba(12,11,10,0.62))', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: '1px solid rgba(200,146,42,0.16)', color: '#e8e2d6' })}>
...
{m.role === 'user' && (
<div style={{ width: '34px', height: '34px', borderRadius: '8px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '4px', fontWeight: 600, color: GOLD, background: 'rgba(200,146,42,0.12)', border: '1px solid rgba(200,146,42,0.3)' }}>T</div>
)}
</div>
))}
{error && (
<div style={{ padding: '1rem', borderRadius: '10px', fontSize: '0.85rem', color: '#f87171', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.15)' }}>
...
<div style={{ padding: '1.25rem', borderTop: '1px solid rgba(200,146,42,0.18)', background: 'rgba(10,9,7,0.72)', backdropFilter: 'blur(18px)', WebkitBackdropFilter: 'blur(18px)' }}>
